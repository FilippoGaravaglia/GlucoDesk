...
namespace GlucoDesk.Desktop.Bootstrap.Providers.DexcomShare;

/// <summary>
/// Builds Dexcom Share provider options from desktop runtime configuration.
/// </summary>
internal static class DesktopDexcomShareProviderOptions
{
    ...
    /// <summary>
    /// Creates Dexcom Share options from environment variables.
    /// </summary>
    /// <returns>The Dexcom Share options.</returns>
    public static DexcomShareOptions FromEnvironment()
    {
