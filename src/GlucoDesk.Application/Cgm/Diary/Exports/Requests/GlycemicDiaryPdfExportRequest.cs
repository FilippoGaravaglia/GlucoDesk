...
/// <summary>
/// Represents a request for exporting a glycemic diary to PDF.
/// </summary>
public sealed record GlycemicDiaryPdfExportRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GlycemicDiaryPdfExportRequest"/> class.
    /// </summary>
    /// <param name="diaryRequest">The diary generation request.</param>
    /// <param name="fileName">The optional exported file name.</param>
    public GlycemicDiaryPdfExportRequest(
